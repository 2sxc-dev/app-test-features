...
namespace AppCode.Data
{
  ...
  /// </summary>
  public partial class TestGetValues: AutoGenerated.ZAutoGenTestGetValues
  {  }
}
...
{
  /// <summary>
  /// Auto-Generated *base* class for 'TestGetValues' in scope 'Default'. It uses special names to avoid accidental use.
  /// </summary>
  public abstract class ZAutoGenTestGetValues: Custom.Data.CustomItem
  {
    /// <summary>
    /// Bool as bool. <br/>
    ...
    /// </returns>
    public new TestGetValues Child => _child ??= _item.Child<TestGetValues>("Child");
    ...
    /// </returns>
    public new IEnumerable<TestGetValues> Children => _children ??= _item.Children<TestGetValues>("Children");
    ...
    /// </summary>
    /// <remarks>
    /// This hides base property File.
    /// To access original, convert using AsItem(...) or cast to ITypedItem.
    /// Consider renaming this field in the underlying content-type.
    /// </remarks>
    public new string File => _item.Url("File");
    ...
    /// </summary>
    /// <remarks>
    /// This hides base property String.
    /// To access original, convert using AsItem(...) or cast to ITypedItem.
    /// Consider renaming this field in the underlying content-type.
    /// </remarks>
    public new string String => _item.String("String", fallback: "");
