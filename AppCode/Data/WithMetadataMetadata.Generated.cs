...
namespace AppCode.Data
{
  ...
  /// </summary>
  public abstract class WithMetadataMetadataAutoGenerated: Custom.Data.Item16
  {
    /// <summary>
    /// Age as int. <br/>
    /// To get other types use methods such as .Decimal("Age")
    /// </summary>
    public int Age => _myItem.Int("Age");

    /// <summary>
    /// Color as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("Color", scrubHtml: true) etc.
    /// </summary>
    public string Color => _myItem.String("Color", fallback: "");
