...
namespace AppCode.Data
{
  ...
  /// </summary>
  public abstract class AdamFieldsMetadataAutoGenerated: Custom.Data.Item16
  {
    /// <summary>
    /// Category as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("Category", scrubHtml: true) etc.
    /// </summary>
    public string Category => _myItem.String("Category", fallback: "");

    /// <summary>
    /// Label as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("Label", scrubHtml: true) etc.
    /// </summary>
    public string Label => _myItem.String("Label", fallback: "");
  }
}