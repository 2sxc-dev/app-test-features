...
namespace AppCode.Data
{
  ...
  /// </summary>
  public abstract class DateTimeConfigurableAutoGenerated: Custom.Data.Item16
  {
    /// <summary>
    /// DesiredDate as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("DesiredDate", scrubHtml: true) etc.
    /// </summary>
    public string DesiredDate => _myItem.String("DesiredDate", fallback: "");

    /// <summary>
    /// Hours as string. <br/>
    /// For advanced manipulation like scrubHtml, use .String("Hours", scrubHtml: true) etc.
    /// </summary>
    public string Hours => _myItem.String("Hours", fallback: "");
  }
}