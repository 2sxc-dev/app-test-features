...
namespace AppCode.Data
{
  ...
  /// </summary>
  public partial class ForPrefillTests: AutoGenerated.ZAutoGenForPrefillTests
  {  }
}
...
{
  /// <summary>
  /// Auto-Generated *base* class for 'ForPrefillTests' in scope 'Default'. It uses special names to avoid accidental use.
  /// </summary>
  public abstract class ZAutoGenForPrefillTests: Custom.Data.CustomItem
  {
    /// <summary>
    ...
    /// <summary>
    /// ManyItemsPicker as single item of ForPrefillTestsCategories.
    /// </summary>
    /// <remarks>
    ...
    /// </returns>
    public ForPrefillTestsCategories ManyItemsPicker => _manyItemsPicker ??= _item.Child<ForPrefillTestsCategories>("ManyItemsPicker");
    private ForPrefillTestsCategories _manyItemsPicker;
    ...
    /// <summary>
    /// SingleItemPicker as single item of ForPrefillTestsCategories.
    /// </summary>
    /// <remarks>
    /// Generated to only return 1 child because field settings had Multi-Value=false. The type ForPrefillTestsCategories was specified in the field settings.
    /// </remarks>
    ...
    /// A single item OR null if nothing found, so you can use ?? to provide alternate objects.
    /// </returns>
    public ForPrefillTestsCategories SingleItemPicker => _singleItemPicker ??= _item.Child<ForPrefillTestsCategories>("SingleItemPicker");
    private ForPrefillTestsCategories _singleItemPicker;
